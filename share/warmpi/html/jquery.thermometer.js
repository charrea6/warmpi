 ...
 *
 * To use this, you need to include jquery, and this file:
 *
 ...
 *      http://code.google.com/p/jsthermometer/
 *
 * I've moved this into a single file and start the scale above the top of the
 * bulb more like a real thermometer.
 */
(function( $ ){
  var methods = {
...
function ThermometerGuage(canvas, options) {
    ...
    function drawTick(y, centerTicks, lineWidth, labelText) {
        ...
        var angleHeight = _.topOfBulb - cy ;
        if (_.centerTicks) {
            cx = w / 2 - tickWidth / 2;
    ...
    function redrawFill() {
      ...
      var fillTop = _.topOfBulb - fillHeight;
